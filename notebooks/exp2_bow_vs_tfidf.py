...
CONFIG = {
    ...
    "test_size": 0.2,
    "mlflow_tracking_uri": os.getenv("MLFLOWT_TRACKING_URL"),
    "dagshub_repo_owner": "nomanmazharr",
    "dagshub_repo_name": "capstone-mlops",
    "experiment_name": "Bow vs TfIdf using multiple models"
}
            ...
            for vec_name, vectorizer in VECTORIZERS.items():
                with mlflow.start_run(run_name=f"{algo_name} with {vec_name}", nested=True) as child_run:
                    try:
                        ...
                        # Log model
                        print("Saving model as artifact")
                        ...
                        print("Saving input example to see how to invoke the model")
                        input_example_path = "input_example.npy"
